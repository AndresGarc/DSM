                                             ...
                                             )
{
        ...
        try
        {
                ...
                if (ex is SuperPetGenNHibernate.Exceptions.ModelException)
                        throw ex;
                throw new SuperPetGenNHibernate.Exceptions.DataLayerException ("Error in ProductoDescripcionCAD.", ex);
        }
...
public int New_ (ProductoDescripcionEN productoDescripcion)
{
        try
        {
                ...
                if (productoDescripcion.Producto != null) {
                        ...
                        productoDescripcion.Producto = (SuperPetGenNHibernate.EN.BaseDatos.ProductoEN)session.Load (typeof(SuperPetGenNHibernate.EN.BaseDatos.ProductoEN), productoDescripcion.Producto.Id);
