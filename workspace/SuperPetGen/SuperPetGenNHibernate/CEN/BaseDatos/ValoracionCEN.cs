...
public int New_ (float p_Valor, string p_usuario, int p_producto)
{
        ...
        if (p_usuario != null) {
                ...
                // Lista de oids id
                valoracionEN.Usuario = new SuperPetGenNHibernate.EN.BaseDatos.UsuarioEN ();
        ...
        if (p_producto != -1) {
                ...
                // Lista de oids id
                valoracionEN.Producto = new SuperPetGenNHibernate.EN.BaseDatos.ProductoEN ();
...
public void Modify (int p_Valoracion_OID, float p_Valor)
{
        ValoracionEN valoracionEN = null;
