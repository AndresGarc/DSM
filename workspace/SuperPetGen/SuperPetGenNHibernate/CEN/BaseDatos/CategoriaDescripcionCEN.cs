...
public int New_ (string p_texto, SuperPetGenNHibernate.Enumerated.BaseDatos.IdiomaEnum p_idioma, int p_categoria)
{
        ...
        if (p_categoria != -1) {
                ...
                // Lista de oids id
                categoriaDescripcionEN.Categoria = new SuperPetGenNHibernate.EN.BaseDatos.CategoriaEN ();
...
public void Modify (int p_CategoriaDescripcion_OID, string p_texto, SuperPetGenNHibernate.Enumerated.BaseDatos.IdiomaEnum p_idioma)
{
        CategoriaDescripcionEN categoriaDescripcionEN = null;
