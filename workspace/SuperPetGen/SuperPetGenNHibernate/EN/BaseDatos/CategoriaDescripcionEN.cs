...
public CategoriaDescripcionEN(int id, string texto, SuperPetGenNHibernate.Enumerated.BaseDatos.IdiomaEnum idioma, SuperPetGenNHibernate.EN.BaseDatos.CategoriaEN categoria
                              )
{
...
private void init (int id
                   , string texto, SuperPetGenNHibernate.Enumerated.BaseDatos.IdiomaEnum idioma, SuperPetGenNHibernate.EN.BaseDatos.CategoriaEN categoria)
{
        this.Id = id;
