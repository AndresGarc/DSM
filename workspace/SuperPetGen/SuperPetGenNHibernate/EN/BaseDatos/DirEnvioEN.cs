...
public DirEnvioEN(int id, string calle, int cP, string localidad, string provincia, System.Collections.Generic.IList<SuperPetGenNHibernate.EN.BaseDatos.PedidoEN> pedido
                  )
{
...
private void init (int id
                   , string calle, int cP, string localidad, string provincia, System.Collections.Generic.IList<SuperPetGenNHibernate.EN.BaseDatos.PedidoEN> pedido)
{
        this.Id = id;
