...
static void Main (string[] args)
{
        ...
        System.Console.WriteLine ("A new database called: SuperPetGenNHibernate will be created (the previous information will be deleted).");
        System.Console.WriteLine ("-----------------------------------------------------------------------------");
        ...
        {
                if (ans.ToLower () == "y") {
                        CreateDB.Create ("SuperPetGenNHibernate", "nhibernateUser", "nhibernatePass");
