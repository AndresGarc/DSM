                                     ...
                                     )
{
        ...
        try
        {
                ...
                if (ex is BaseDatosGenNHibernate.Exceptions.ModelException)
                        throw ex;
                throw new BaseDatosGenNHibernate.Exceptions.DataLayerException ("Error in LineaPedidoCAD.", ex);
        }
...
public int New_ (LineaPedidoEN lineaPedido)
{
        try
        {
                ...
                if (lineaPedido.Producto != null) {
                        ...
                        lineaPedido.Producto = (BaseDatosGenNHibernate.EN.BaseDatos.ProductoEN)session.Load (typeof(BaseDatosGenNHibernate.EN.BaseDatos.ProductoEN), lineaPedido.Producto.Id);
                ...
                if (lineaPedido.Pedido != null) {
                        // Argumento OID y no colección.
                        lineaPedido.Pedido = (BaseDatosGenNHibernate.EN.BaseDatos.PedidoEN)session.Load (typeof(BaseDatosGenNHibernate.EN.BaseDatos.PedidoEN), lineaPedido.Pedido.Id);
                     ...
                     )
{
        ...
        {
                SessionInitializeTransaction ();
                LineaPedidoEN lineaPedidoEN = (LineaPedidoEN)session.Load (typeof(LineaPedidoEN), Numero);
...
//Sin e: MuestraLineaPedidoPorOID
//Con e: LineaPedidoEN
