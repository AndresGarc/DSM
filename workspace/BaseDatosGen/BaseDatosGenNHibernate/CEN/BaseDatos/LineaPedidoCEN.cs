...
public int New_ (int p_Cantidad, int p_producto, int p_pedido)
{
        ...
        if (p_producto != -1) {
                ...
                lineaPedidoEN.Producto = new BaseDatosGenNHibernate.EN.BaseDatos.ProductoEN ();
        ...
        if (p_pedido != -1) {
                ...
                // Lista de oids Numero
                lineaPedidoEN.Pedido = new BaseDatosGenNHibernate.EN.BaseDatos.PedidoEN ();
